...
如果您在[以品牌为中心的体验](/help/overview/quick-start.md#brand-centric-experience)，请导航到&#x200B;**品牌管理**，以设置和配置品牌、品牌别名并定义要跟踪的竞争对手。 **品牌管理**&#x200B;还用于配置与品牌关联的URL相关的集成，例如Google Search Console、Adobe Analytics和CDN日志转发。 您可以通过单击相应的选项卡（GSC、CDN等）来执行此操作。
...
从&#x200B;**提示**&#x200B;选项卡，您可以查看、管理和自定义提示。 您可以上传[品牌存在感分析](/help/dashboards/brand-presence.md)的 .csv 文件，该列表中将填充该分析中的提示和主题，或者[下载 Adobe 创建的提示库](/help/overview/best-practices-topics-prompts.md)。 您也可以按需删除、修改或添加主题及其关联的提示词。
...
对于使用[以品牌为中心的体验](/help/overview/quick-start.md#brand-centric-experience)的客户，要添加主题和提示，请导航到&#x200B;**提示管理**。

![提示管理（以品牌为中心的体验）](/help/assets/brand-centric-experience/prompts-management.png)
...
1. 打开&#x200B;**客户配置**&#x200B;仪表板（经典导航）或&#x200B;**品牌管理**（品牌导向体验），然后转到Google Search Console集成（品牌导向体验中的GSC标记）。
...
添加查询后，该查询将显示在“客户配置”仪表板的[提示](#prompts-brand)选项卡中（经典导航）或&#x200B;**提示管理** （以品牌为中心的体验）中。 来自 Google Search Console 的提示词在&#x200B;**源站**&#x200B;列中会有一个 Google Search Console 图标的标记。 此图标可帮助您区分基于实际用户搜索行为的提示词与手动添加或其他来源的提示词。
