...
使用Adobe Analytics [反向链接类型 — 对话式AI工具](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/referrer-type#conversational-ai-tools)识别LLM产生的流量。
