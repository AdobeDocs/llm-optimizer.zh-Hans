...
![CDN提供程序](/help/dashboards/assets/ag-log-forward3.png)
...
“排名最前和最低移动者”视图突出显示代理流量中具有最大周内变化的URL — 来自AI系统的访问或点击访问您的内容。 排名最前的移动器显示页面获得可见性或参与度，而排名最下方的移动器显示降幅最大的URL。 这有助于您快速识别哪些内容呈上升趋势、哪些内容可能需要关注，以及人工智能驱动的发现模式在哪里发生变化。
...
对于这两个表，您可以使用&#x200B;**导出**&#x200B;选项来下载表.csv，并与团队共享见解，或者在执行报表中包含该表。
