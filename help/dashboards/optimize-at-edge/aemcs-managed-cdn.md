...
**4. 检查LLM Optimizer**&#x200B;中的路由状态

您还可以在LLM Optimizer UI中确认路由。 打开&#x200B;**客户配置**&#x200B;并选择&#x200B;**CDN配置**&#x200B;选项卡。 当路由处于活动状态时，**将优化部署到AI代理**&#x200B;部分显示&#x200B;**已完成**。
