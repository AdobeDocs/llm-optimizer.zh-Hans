...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./brand-presence.md" title="品牌展示功能板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/brand-presence-card.png" alt="品牌展示功能板"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">跟踪您的品牌在LLM搜索平台中的显示方式，包括情绪分析和竞争对手基准设定。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Agentic traffic dashboard">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./agentic-traffic.md" title="代理流量仪表板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/agentic-traffic-card.png" alt="代理流量仪表板"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./agentic-traffic.md" target="_blank" rel="referrer" title="代理流量仪表板">代理流量仪表板</a>
                    </p>
                    <p class="is-size-6">揭示传统分析所缺失的LLM流量，帮助您将AI辅助发现与参与和收入联系起来。</p>
                </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./referral-traffic.md" title="反向链接流量仪表板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/referral-traffic-card.png" alt="反向链接流量仪表板"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Collaboration dashboard">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./collaboration.md" title="Collaboration功能板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/collaboration-card.png" alt="Collaboration功能板"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./collaboration.md" target="_blank" rel="referrer" title="Collaboration功能板">Collaboration仪表板</a>
                    </p>
                    <p class="is-size-6">允许您通过邀请同事加入共享工作区来启用跨职能团队合作。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Opportunities dashboard">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./opportunities.md" title="机会信息板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/opportunities-card.png" alt="机会信息板"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="URL inspector dashboard">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./url-inspector.md" title="URL检查器仪表板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/url-inspector-card.png" alt="URL检查器仪表板"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./url-inspector.md" target="_blank" rel="referrer" title="URL检查器仪表板">URL检查器仪表板</a>
                    </p>
                    <p class="is-size-6">让您能够了解自己的URL在AI驱动的搜索环境中的执行情况。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Customer Configuration dashboard">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./customer-configuration.md" title="客户配置仪表板" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/customer-configuration-card.png" alt="客户配置仪表板"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./customer-configuration.md" target="_blank" rel="referrer" title="客户配置仪表板">客户配置仪表板</a>
                    </p>
                    <p class="is-size-6">允许组织控制Adobe LLM Optimizer如何针对其特定需求运行。</p>
                </div>
